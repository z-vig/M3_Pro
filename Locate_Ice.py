...
if __name__ == "__main__":
    ...
    np.save(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/Corrected_Image.npy',correctedImage)
    ...
    print ('Saving Images...')
    tf.imwrite(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/original.tif',originalImage,photometric='rgb')
    tf.imwrite(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/destriped.tif',destripeImage,photometric='rgb')
    tf.imwrite(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/corrected.tif',correctedImage,photometric='rgb')
    tf.imwrite(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/smoothed.tif',smoothSpecImg,photometric='rgb')
    tf.imwrite(f'D:/Data/Locate_Ice_Saves/{img1.datetime}/water_locations.tif',waterLocations,photometric='rgb')
    print (f'Images saved at {time.time()-start} seconds')
