...
def sa_mapping(save_step:bool)->None:
    ...
    for input_path,loc_path,obs_path,stamp_name in zip(all_input_paths,all_loc_paths,all_obs_paths,stamp_names):
        ...
        summary_df,spec_ang_bool = stamp_object.spectral_angle_mapping(reference_spectrum=USGS_frost,threshold=THRESH,save_step=save_step)
